...
const mensajesDeError = {
    ...
    password: {
        ...
        patternMismatch: "Al menos 6 caracteres, maximo 12, debe contener 1 letra minuscula, 1 letra mayuscula y 1 numero, no puede contener caracteres especiales."
    },
    nacimiento: {
        valueMissing: "Este campo fecha de naciomiento no puede estar vacio",
...
function validarNacimiento(input){
    ...
    if(!mayorDeEdad(fechaCliente)){
        mensaje = "Debes tener al menos 18 añosde edad"
    }
